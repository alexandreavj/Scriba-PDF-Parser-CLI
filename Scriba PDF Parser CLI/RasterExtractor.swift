...
func getXObjectDictionary(from page: CGPDFPage) -> CGPDFDictionaryRef? {
...
func isImageStream(_ dict: CGPDFDictionaryRef) -> Bool {
...
func fileExtension(for format: CGPDFDataFormat, data: CFData) -> String {
...
func saveImage(_ extracted: ExtractedImage, to outputDir: URL, index: Int) -> Bool {
